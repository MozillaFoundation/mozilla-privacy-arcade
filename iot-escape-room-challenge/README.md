...
That’s the question this IoT Escape Room Challenge tries to answer. Your job is to design and an inexpensive, portable IoT [“escape room”](https://en.wikipedia.org/wiki/Escape_room) and prototype facilitation and storytelling guides for it that let participants:

- ***Feel safe and welcome*** interacting with one another and the connected devices in your room.
- ***Have fun solving puzzles*** posed by those devices to “unlock” a way out of the room.
- ***Fit super-comfortably inside the room’s frame*** with lots of personal space while including 3-5 people at a time.
- ***Interact with common types of IoT devices*** mounted to the room’s frame to explore how they work with the web and interact with people.
- ***Try to create interactions between objects*** such as conversations between home assistants.
- ***Experience and understand generic, scripted, low-risk challenges*** posed by the devices like home-hacks, invasions of privacy, or malware infections.
...
You can also make a [paper prototype](http://www.instructables.com/id/Paper-Crafting-101/) or [cardboard prototype](https://www.youtube.com/watch?v=k_9Q-KDSb9o) of your room to show how it works.
...
- Prototype a room.
- Build a room.
- Write puzzles for the room.
- Write a guide for using specific devices.
- Write a guide for teaching about IoT with the room.
- Write a story to go along with a room.
- Write code for running puzzles on IoT devices in a room.
...
- ***Build the room*** themselves from inexpensive, locally sourced parts.
- ***Purchase or make any needed IoT devices*** or mock-ups at low cost.
- ***Repeatedly program, set up, and reset the IoT devices*** using instructions you provide.
- ***Repeatedly set up and facilitate the escape room experience*** using a guide you provide.
- ***Easily break down, pack, and inexpensively ship the room*** to another library in the same network or region to share costs and programming.

Here are some ideas to get you started. Participants might use the devices to:

- ***Figure out where they are*** or who has caught them  in an IoT Escape Room decorated to suggest a particular place or person.
- ***Research clues*** from a library’s collection to escape.
- ***Find the right combination*** to unlock the IoT Escape Room.
...
- Someone who loves to tell stories might contribute several escape room scenarios explaining how IoT devices might have malfunctioned (or did they?) and trapped the players.
- Someone who loves puzzles might contribute several brain teasers associated with online safety ideas like encryption (codes), password strength, data collection, or surveillance.
- Someone who loves to draw online or off might contribute sketches of a room that is decorated to go along with someone else's story or that includes devices suggested by another contributor.
- Someone who loves to teach might write a facilitation guide for an escape room design.
- Someone who loves working with technology might suggest several devices that would be good to use or write instructions for how to use or code a device in the escape room.
...
- [EZ Farm uses the Internet of Things to Improve Food Security in Africa](https://www.youtube.com/watch?v=mcUbd8YmzbQ)
...
- [Tips on Designing Room Escape Games](http://www.realityisagame.com/archives/3109/tips-on-designing-room-escape-games/) 
- [Behind the Scenes of the Escape Room Craze](https://www.youtube.com/watch?v=Mrn3imTXXw0) 
- [Escape Rooms in India](http://worldofescapes.in/)   
